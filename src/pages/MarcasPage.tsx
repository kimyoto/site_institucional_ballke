  ...
  return (
    <> 
      ...
      <section className="marcas-content-section">
        ...
        />
        <p className="marca-text text-bbranding">
            TEXTO BBRANDIG        </p>
